...
type ContextManagementSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	setCachedStateField: SetCachedStateField<
		"maxOpenTabsContext" | "maxWorkspaceFiles" | "showBinahIgnoredFiles" | "maxReadFileLine"
	>
}
	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						checked={showBinahIgnoredFiles}
						onChange={(e: any) => setCachedStateField("showBinahIgnoredFiles", e.target.checked)}
						data-testid="show-binahignored-files-checkbox">
						<label className="block font-medium mb-1">
							{t("settings:contextManagement.binahignore.label")}
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1">
						{t("settings:contextManagement.binahignore.description")}
					</div>
				</div>
