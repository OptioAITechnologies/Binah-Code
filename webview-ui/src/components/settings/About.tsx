			...
			<Section>
				...
				<div>
					<Trans
						...
						components={{
							githubLink: <VSCodeLink href="https://github.com/RooVetGit/Binah" />,
							redditLink: <VSCodeLink href="https://reddit.com/r/Binah" />,
							discordLink: <VSCodeLink href="https://discord.gg/binah" />,
						}}
					/>
				</div>
