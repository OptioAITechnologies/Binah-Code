...
build_extension() {
  echo "🔨 Building the Binah extension..."
  cd ..
  mkdir -p bin
...
echo "🗄️ Syncing Binah evals database..."
...
if [[ ! -s "../bin/roo-code-latest.vsix" ]]; then
  ...
  read -p "💻 Do you want to build a new version of the Binah extension? (y/N): " build_extension
